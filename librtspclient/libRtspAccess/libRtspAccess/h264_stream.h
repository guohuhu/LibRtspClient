...
void read_nal_unit(h264_stream_t* h, unsigned char* buf, int size);
...
void write_nal_unit(h264_stream_t* h, unsigned char* buf, int size);
...
//#define SH_SLICE_TYPE_P        5        // P (P slice)
//#define SH_SLICE_TYPE_B        6        // B (B slice)
//#define SH_SLICE_TYPE_I        7        // I (I slice)
//#define SH_SLICE_TYPE_SP       8        // SP (SP slice)
//#define SH_SLICE_TYPE_SI       9        // SI (SI slice)
